...
import { DateTimeV2 } from './../src/prebuilt/DateTimeV2';
import { prebuiltTypes } from './../src/prebuilt/index';
...
describe('LuisResponseBuilder', () => {
    ...
    it('adds entites', () => {
        ...
        // tslint:disable
        expect(find(entities, (entity: IEntity) => entity.type === `${prebuiltTypes.datetimeV2Type}.${prebuiltTypes.datetimeV2.datetimeV2DateType}`)).not.to.be.undefined;
        expect(find(entities, (entity: IEntity) => entity.type === 'restaurantName' && entity.entity === 'taco bell')).not.to.be.undefined;
        expect(find(entities, (entity: IEntity) => entity.type === 'restaurantName' && entity.entity === 'benu')).not.to.be.undefined;
        // tslint:enable
    });
});
